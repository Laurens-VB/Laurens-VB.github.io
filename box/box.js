		...
		render(val, info, color, opslaan, useCookie, treshholds, strValue) {
			...
			if(strValue != undefined){
				...
				if(rounded >=0 && rounded <=100) {
					...
					dummyValue + '%</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"';
				}
			}
