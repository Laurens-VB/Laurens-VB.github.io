		...
		render(val, info, color, opslaan, useCookie, treshholds, strValue, measureValue, compareTo) {
			...
			if(strValue != undefined)
			{
				...
				if(rounded >=0 && rounded <=100) {
					...
					this.$svg.innerHTML = '<path d="M 950 500 A 450 450 0 0 0 50 500"></path><text text-anchor="middle" alignment-baseline="middle" x="500" y="300" font-size="140" font-weight="bold">' + teller + '</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + "/" + compareTo +  '</text><path d="' + x + '" class="data-arc"></path>"';
				}
			}
			else{
